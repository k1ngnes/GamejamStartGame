...
namespace Articy.Jam.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Jam.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.Jam.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
        ...
        {
            Articy.Jam.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.Jam.Features.DefaultExtendedCharacterFeatureFeature();
