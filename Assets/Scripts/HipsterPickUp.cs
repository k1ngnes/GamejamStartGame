...
public class HipsterPickUp : MonoBehaviour
{
    [SerializeField] private PlayerController playerController;
    [SerializeField] private LayerMask pickUpMask;
    [SerializeField] private float pickUpRadius = 0.4f;
    [SerializeField] private Hipster hipster;
    ...
    public void WearHipster()
    {
        playerController.SetIsHipsterOn(true);
        hipster.HipsterPickUp();
    }
